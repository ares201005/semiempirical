...
species = torch.as_tensor([[7,9,9,9]],dtype=torch.int64, device=device)
coordinates = torch.tensor([
                  [
                    [ 0.0000000,  -0.0000000,  -0.3989919],
                    [ 0.6277200,  -1.0872430,   0.0980534],
                    [ 0.6277200,   1.0872430,   0.0980534],
                    [-1.2554401,   0.0000000,   0.0980534]
                  ]
                 ], device=device)
