...
with open('tabulated_comparison_big.txt','w') as wfile:
	...
	for f in mndo_files:
		...
		mol = gto.M(atom='geoms/fulgimide.xyz',spin=0)
		if model == 'mindo3':
		...
		py_ee = py_scf - py_ne
		wfile.write(f'{model.upper()+" SCF":>10} {scf:>16.5f} {py_scf:>16.5f} {py_scf:>16.8f}\n')
		wfile.write(f'{model.upper()+" EE ":>10} {ee:>16.5f} {py_ee0:>16.5f} {py_ee0:>16.8f}\n')
		wfile.write(f'{model.upper()+" EE ":>10} {ee:>16.5f} {py_ee:>16.5f} {py_ee:>16.8f}\n')
		wfile.write(f'{model.upper()+" NE ":>10} {ne:>16.5f} {py_ne:>16.5f} {py_ne:>16.8f} \n\n')
