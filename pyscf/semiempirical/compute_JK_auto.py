...
from .rotation_matrix_auto import rotation_matrix_auto

def compute_JK_auto(mol, dm, params, atom_list_sorted):
    ...
    for ia in atom_list_sorted[0]:
        ...
        r05  = 0.0
        w = W11_auto(r05, params.am[zi], params.ad[zi], params.am[zi], params.ad[zi], params.aq[zi], params.aq[zi], params.dd[zi], params.dd[zi], params.qq[zi], params.qq[zi]*2, params.qq[zi], params.qq[zi]*2)
        # Rotation is unecessary
        matrix_print_2d(27.21*w,5,'W_ll_auto diag 2')
        #########################
    ...
    for ia in atom_list_sorted[1]:
        ...
        r05  = 0.0
        w = W22_auto(r05, params.am[zi], params.ad[zi], params.am[zi], params.ad[zi], params.aq[zi], params.aq[zi], params.dd[zi], params.dd[zi], params.qq[zi], params.qq[zi]*2, params.qq[zi], params.qq[zi]*2)
        #xij  = numpy.subtract(xi, xi)
        #T2 = rotation_matrix_auto(xij)
        #w = numpy.einsum('ij,ik,kl->jl', T2, w, T2)
        matrix_print_2d(27.21*w,5,'W_hh_auto diag 2')
        #########################
    ...
    for ia in atom_list_sorted[0]:
        for ja in atom_list_sorted[0]:
            if ja < ia: 
                ...
                r05  = 0.5 * rij
                w = W11_auto(r05, params.am[zi], params.ad[zi], params.am[zj], params.ad[zj], params.aq[zi], params.aq[zj], params.dd[zi], params.dd[zj], params.qq[zi], params.qq[zi]*2, params.qq[zj], params.qq[zj]*2)
                T2 = rotation_matrix_auto(xij)
                w = numpy.einsum('ij,ik,kl->jl', T2, w, T2)
                matrix_print_2d(27.21*w,5,'W_ll_auto offdiag 2')
                #########################
    ...
    for ia in atom_list_sorted[0]:
        for ja in atom_list_sorted[1]:
            ...
            rij  = numpy.linalg.norm(xij)
            r05  = 0.5 * rij
            # should have lh instead of hl... indices changed to match hl with lh indexing
            w = W21_auto(r05, params.am[zj], params.ad[zj], params.am[zi], params.ad[zi], params.aq[zj], params.aq[zi], params.dd[zj], params.dd[zi], params.qq[zj], params.qq[zj]*2, params.qq[zi], params.qq[zi]*2)
            T2 = rotation_matrix_auto(xij)
            w = numpy.einsum('ij,ik,kl->jl', T2, w, T2)
            matrix_print_2d(27.21*w,5,'W_lh_auto offdiag 2')
            #########################
    ...
    for ia in atom_list_sorted[1]:
        for ja in atom_list_sorted[1]:
            if ja < ia: 
                ...
                rij  = numpy.linalg.norm(xij)
                r05  = 0.5 * rij
                w = W22_auto(r05, params.am[zi], params.ad[zi], params.am[zj], params.ad[zj], params.aq[zi], params.aq[zj], params.dd[zi], params.dd[zj], params.qq[zi], params.qq[zi]*2, params.qq[zj], params.qq[zj]*2)
                T2 = rotation_matrix_auto(xij)
                w = numpy.einsum('ij,ik,kl->jl', T2, w, T2)
                matrix_print_2d(27.21*w,5,'W_hh_auto offdiag 2')
                #########################
